...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var get_blob_duration__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! get-blob-duration */ \"./node_modules/get-blob-duration/dist/getBlobDuration.js\");\n/* harmony import */ var get_blob_duration__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(get_blob_duration__WEBPACK_IMPORTED_MODULE_1__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\nvar videoContainer = document.getElementById('jsVideoContainer');\nvar videoPlayer = document.querySelector('#jsVideoPlayer');\nvar currentTime = document.querySelector('#jsCurrentTime');\nvar totalTime = document.querySelector('#jsTotalTime');\nvar playBtn = document.querySelector('#jsPlayButton');\nvar volumeBtn = document.querySelector('#jsVolumeButton');\nvar fullScreenBtn = document.querySelector('#jsFullScreenButton');\nvar volumeRange = document.querySelector('#jsVolume');\nvar viewString = document.querySelector('#jsViewString');\nvar PLAY_ICON = \"<i class=\\\"fas fa-play\\\"></i>\";\nvar PAUSE_ICON = \"<i class=\\\"fas fa-pause\\\"></i>\";\nvar VOLUME_MEDIUM = \"<i class=\\\"fas fa-volume-down\\\"></i>\";\nvar VOLUME_MUTED = \"<i class=\\\"fas fa-volume-mute\\\"></i>\";\nvar VOLUME_UP = '<i class=\"fas fa-volume-up\"></i>';\nvar VOLUME_DOWN = '<i class=\"fas fa-volume-down\"></i>';\nvar VOLUME_OFF = '<i class=\"fas fa-volume-off\"></i>';\nvar FULLSCREEN = \"<i class=\\\"fas fa-expand\\\"></i>\";\nvar FULLSCREEN_OUT = \"<i class=\\\"fas fa-compress\\\"></i>\";\n\nvar volumeMuteIcon = function volumeMuteIcon() {\n  return volumeBtn.innerHTML = VOLUME_MUTED;\n};\n\nvar volumeMediumIcon = function volumeMediumIcon() {\n  return volumeBtn.innerHTML = VOLUME_MEDIUM;\n};\n\nvar volumeFullIcon = function volumeFullIcon() {\n  return volumeBtn.innerHTML = VOLUME_FULL;\n};\n\nvar volumeUpIcon = function volumeUpIcon() {\n  return volumeBtn.innerHTML = VOLUME_UP;\n};\n\nvar volumeDownIcon = function volumeDownIcon() {\n  return volumeBtn.innerHTML = VOLUME_DOWN;\n};\n\nvar volumeOffIcon = function volumeOffIcon() {\n  return volumeBtn.innerHTML = VOLUME_OFF;\n};\n\nvar playerPlayIcon = function playerPlayIcon() {\n  return playBtn.innerHTML = PLAY_ICON;\n};\n\nvar playerPauseIcon = function playerPauseIcon() {\n  return playBtn.innerHTML = PAUSE_ICON;\n};\n\nvar fullscreenIcon = function fullscreenIcon() {\n  return fullScreenBtn.innerHTML = FULLSCREEN;\n};\n\nvar outFullScreenIcon = function outFullScreenIcon() {\n  return fullScreenBtn.innerHTML = FULLSCREEN_OUT;\n}; // function handlePlayClick({\n//     if (videoPlayer.paused){\n//         videoPlayer.play();\n//     } else {\n//         videoPlayer.pause()\n//     }\n// })\n\n\nvar registerView = function registerView() {\n  var videoId = window.location.href.split('/videos/')[1]; //   console.log(videoId);\n\n  fetch(\"/api/\".concat(videoId, \"/view\"), {\n    method: 'post'\n  }).then(function (response) {\n    return response.json();\n  }).then(function (responseJson) {\n    viewString.innerHTML = responseJson.views;\n  });\n};\n\nvar handlePlayClick = function handlePlayClick() {\n  if (videoPlayer.paused) {\n    // readonly - 불리언값 줌\n    videoPlayer.play();\n    playerPauseIcon();\n  } else {\n    videoPlayer.pause();\n    playerPlayIcon();\n  }\n};\n\nvar handleVolumeClick = function handleVolumeClick() {\n  if (videoPlayer.muted) {\n    // 이건 readonly 아님 - 불리언값 줌\n    videoPlayer.muted = false;\n    volumeMediumIcon();\n    volumeRange.value = videoPlayer.volume;\n  } else {\n    videoPlayer.muted = true;\n    volumeMuteIcon();\n    volumeRange.value = 0;\n  }\n};\n\nvar handleDrag = function handleDrag(event) {\n  var value = event.target.value;\n  videoPlayer.volume = value;\n\n  if (value >= 0.7) {\n    volumeUpIcon();\n  } else if (value >= 0.3) {\n    volumeDownIcon();\n  } else {\n    volumeOffIcon();\n  }\n};\n\nvar restoreVolume = function restoreVolume() {\n  var volume = localStorage.getItem('volume'); //   console.log(volume);\n\n  if (volume) {\n    videoPlayer.volume = volume;\n    volumeRange.value = volume;\n  } else {\n    videoPlayer.volume = 0.5;\n  }\n};\n\nvar enterFullScreen = function enterFullScreen() {\n  // 그냥 함수는 지원 안 해서 webkit(크롬엔진) 쓰라고 되어 있음\n  // 익스플로러는 ms / 모질라는 moz\n  if (videoContainer.requestFullscreen) {\n    videoContainer.requestFullscreen();\n  } else if (videoContainer.mozRequestFullscreen) {\n    videoContainer.mozRequestFullScreen();\n  } else if (videoContainer.webkitRequestFullScreen) {\n    videoContainer.webkitRequestFullscreen();\n  } else if (videoContainer.msRequestFullscreen) {\n    videoContainer.msRequestFullscreen();\n  }\n\n  outFullScreenIcon();\n  fullScreenBtn.removeEventListener('click', enterFullScreen); // 이벤트 리스너 삭제\n\n  fullScreenBtn.addEventListener('click', exitFullScreen); // 이벤트 리스너 추가\n};\n\nvar exitFullScreen = function exitFullScreen() {\n  fullscreenIcon();\n\n  if (document.exitFullscreen) {\n    document.exitFullscreen();\n  } else if (document.mozCancelFullScreen) {\n    document.mozCancelFullScreen();\n  } else if (document.webkitExitFullscreen) {\n    document.webkitExitFullscreen();\n  } else if (document.msExitFullscreen) {\n    document.msExitFullscreen();\n  }\n\n  fullScreenBtn.removeEventListener('click', exitFullScreen);\n  fullScreenBtn.addEventListener('click', enterFullScreen);\n};\n\nvar formatData = function formatData(seconds) {\n  var secondsNumber = parseInt(seconds, 10); // don't forget the second param\n\n  var hours = Math.floor(secondsNumber / 3600);\n  var minutes = Math.floor((secondsNumber - hours * 3600) / 60);\n  var totalSeconds = secondsNumber - hours * 3600 - minutes * 60;\n\n  if (hours < 10) {\n    hours = \"0\".concat(hours);\n  }\n\n  if (minutes < 10) {\n    minutes = \"0\".concat(minutes);\n  }\n\n  if (seconds < 10) {\n    totalSeconds = \"0\".concat(totalSeconds);\n  }\n\n  return \"\".concat(hours, \":\").concat(minutes, \":\").concat(totalSeconds);\n};\n\nvar setCurrentTime = function setCurrentTime() {\n  currentTime.innerHTML = formatData(Math.floor(videoPlayer.currentTime));\n};\n\nvar setTotalTime = /*#__PURE__*/function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n    var videoBlob, duration, totalTimeString;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.next = 2;\n            return fetch(videoPlayer.src).then(function (response) {\n              return response.blob();\n            });\n\n          case 2:\n            videoBlob = _context.sent;\n            // videoBlob.type = 'video/mp4';\n            // 이 부분 주석처리하니까 Nan 오류 해결됨\n            console.log(\"videoBlob:\".concat(videoBlob));\n            _context.next = 6;\n            return get_blob_duration__WEBPACK_IMPORTED_MODULE_1___default()(videoBlob);\n\n          case 6:\n            duration = _context.sent;\n            // console.log('duration:', duration);\n            totalTimeString = formatData(duration); // console.log('totalTimeString:', duration);\n\n            totalTime.innerHTML = totalTimeString;\n            setInterval(setCurrentTime, 1000);\n\n          case 10:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function setTotalTime() {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nvar handleEnded = function handleEnded() {\n  videoPlayer.currentTime = 0;\n  playerPlayIcon();\n};\n\nvar initVideoPlayer = function initVideoPlayer() {\n  restoreVolume();\n  playBtn.addEventListener('click', handlePlayClick);\n  volumeBtn.addEventListener('click', handleVolumeClick); // 풀스크린 체크해주는 함수가 없어서 이벤트리스너를 바꾸는 방식으로 해야됨\n\n  fullScreenBtn.addEventListener('click', enterFullScreen); // 비디오가 메타데이터를 로드할 때까지 기다려야함\n  // 그냥 함수바로 쓰면 메타 데이터 로드 전이라서 계산이 안 돼서 Nan 뜸\n\n  videoPlayer.onloadedmetadata = setTotalTime();\n  videoPlayer.addEventListener('loadedmetadata', setTotalTime);\n  videoPlayer.addEventListener('ended', handleEnded);\n  volumeRange.addEventListener('input', handleDrag);\n}; // js파일이 하상 모든 페이지 footer 아래 include되는 걸 명심!\n// 이벤트리스너를 이용했을 때 해당 id 못찾으면 null이 돼서 에러냄\n\n\nif (videoContainer) {\n  registerView();\n  initVideoPlayer();\n}\n\n//# sourceURL=webpack:///./assets/js/videoPlayer.js?");
...
eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! /Users/admin/Desktop/wetube/assets/js/main.js */\"./assets/js/main.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./assets/js/main.js?");
